...
# Contoh penggunaan
csv_folder_path = '../northwind_CSV'  # Ganti dengan path folder yang berisi file CSV Anda
db_url = 'postgresql://postgres:12345678@localhost:5432/db_project_northwind'  # Ganti dengan URL koneksi PostgreSQL Anda
